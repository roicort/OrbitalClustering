...
La relevancia de los graphlets va más allá de la comparación de grafos. Recien- temente se ha sugerido que la presencia, o ausencia, de ciertas estructuras locales dentro de una red podría tener un impacto crítico en la estructura general de la red [Lus].
